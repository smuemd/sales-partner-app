...
let authLevel = localStore.getItem('user:authLevel') || undefined
  ...
  return {
    ...
    user: {
      ...
      localNode: {
        ...
        address:
          localStore.getItem('user[' + extId + ']:localNode:address') ||
          undefined,
        pk: localStore.getItem('user[' + extId + ']:localNode:pk') || undefined
      },
      remoteNode: {
        address:
          localStore.getItem('user[' + extId + ']:remoteNode:address') ||
          undefined
      }
    },
    partnerAccount: {
