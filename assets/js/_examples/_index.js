...
function main (start) {
  ...
  const settings = {
    ...
    demoDefaults: {
      ...
      accounts: [
        { name: 'One', meta: 'UST', publicKey: '0x4caB5660420BECAF280553b8c5634668379b81E0' },
        { name: 'Two', meta: 'EEG', publicKey: '0x9B6084a9a35Fc638A67Fd43d6c73B9325263D2f5' },
        { name: 'Three', meta: 'Stromsteuer', publicKey: '0xE4Dd81107246BC8366a28b2F346c1F3C0146526d' },
        { name: 'Four', meta: 'Konzessionsabgabe', publicKey: '0xC3d7291E403703Ae8BbF1d924C854c60B617D611' },
        { name: 'Five', meta: 'KWK Umlage', publicKey: '0xAc67A65B42186284e3c1748927Ce2590ad51390b' },
        { name: 'Six', meta: '§19 Umlage', publicKey: '0x5be5c47D592f1eaE734c2f297a396bb5DE2610d5' },
        { name: 'Seven', meta: 'Logistik', publicKey: '0x6011229E95916A766DC525b68866CB082be4b252' }
      ]
    },
    routePrefix: '#',
    defaultRoute: '/',
...
function createActions (model, dataApi) {
  ...
  function onNavigateTo (routeName, params) {
    ...
    if (!params.publicKey) {
      ...
      fetchAccountInfo(params.publicKey)
        .then(data => {
          let accountInfo = {}
